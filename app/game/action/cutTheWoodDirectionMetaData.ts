...
export const cutTheWoodDirectionMetaData: ActionMetadataInterface<GoDirectionDataInterface> =
  {
    ["@type"]: "action/cutTheHood",
    ...
    factory: (payload: { entity: EntityInterface; target: Vector3Interface }) => {
      ...
      return jsonLdFactory(cutTheWoodDirectionMetaData["@type"], { data })
    },
  }
