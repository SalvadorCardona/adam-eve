...
export function setContainerValue<T>(container: ContainerInterface<T>, key: JsonLdIri, value: T): void {
  container[key] = value;
}

export function deleteContainerKey<T>(container: ContainerInterface<T>, key: JsonLdIri): void {
